...
export const AUTH_ROLES = {
  customer: {
    ...
    photo: '/media/role-customer-spread.jpg',
    photoAlt: 'A spread of chicken biryani, seekh kebabs, naan, curry, a burger with fries, salad and firni',
    // Every dish must stay in view on the login/signup page, so it is fitted there instead of cropped.
    photoFit: 'contain',
    accent: 'orange',
